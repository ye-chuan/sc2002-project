...
/**
 * This class is provides the menu to be printed in the reply enquiry UI.
 * This class is called when the user is staff and a camp committee of a camp. 
...
public class MenuEquiryReply implements IPrintMenu{
    ...
    /** 
     * This method is to print the list of option for the reply enquiry menu
     * 
